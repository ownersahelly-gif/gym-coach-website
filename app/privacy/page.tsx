  ...
  return (
    <PolicyPage
      ...
      sections={[
        ...
        { heading: "How we use your information", body: "Your information is used solely to deliver and personalise your coaching, communicate with you about your program, and process your enrolment. We never sell or rent your personal data to third parties." },
